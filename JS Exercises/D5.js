...
while (t < numericArray.length) {
  console.log(numericArray[t]);
  if (numericArray[t] === 32) {
    break;
  }
  t++;
}
...
for (let i = 0; i < charactersArray.length; i++) {
  ...
  switch (lettera) {
    ...
    case "z":
      ...
      break;
    default:
      console.log("Carattere non conosciuto");
      break;
  }
}
...
//non sapevo se dovevo creare delle funzioni per questi esercizi ma non essendo
//specificato da nessuna parte di creare delle funzioni non le ho fatte, spero vada bene
